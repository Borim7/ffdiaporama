...
#include "libavfilter/avfiltergraph.h"
    ...
    #if ((LIBAVUTIL_VERSION_INT>=AV_VERSION_INT(55,17,100))&&(LIBAVCODEC_VERSION_INT>=AV_VERSION_INT(55,52,102))&&(LIBAVFORMAT_VERSION_INT>=AV_VERSION_INT(55,33,100))&& \
...
#if !defined(FF_API_CODEC_ID) and !defined(FF_API_CODEC_NAME)
